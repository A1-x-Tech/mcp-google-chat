 ...
 * environment versions ever leave the machine. The OAuth credentials, chat
 * messages, tool arguments, prompts and the names or values of environment
 ...
 * comparable. `unconfigured_start` is its live counterpart — the server
